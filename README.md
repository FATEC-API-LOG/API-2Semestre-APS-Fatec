...
| :---: | :---: | :--- | :---: | :---: |
| **1** | Alta | **Como** analista do ONSV, **quero** visualizar cartões e gráficos com as taxas de mortes por 100 mil hab. e sinistros por 10 mil veículos, **para que** eu compare o desempenho regional com a média do Brasil. |  | 1 |
...
| **7** | Baixa | **Como** analista do ONSV, **quero** visualizar cartões e gráficos com as taxas de mortes por 100 mil hab. e sinistros por 10 mil veículos, **para que** eu compare o desempenho de São José dos Campos com a média do estado de São Paulo. |  | 3 |
